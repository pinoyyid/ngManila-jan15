...
module Todo {
    ...
    export class RestServer {
        ...
        URL = "http://localhost:8080/tasks/v1/lists/MDM4NjIwODI0NzAwNDQwMjQ2MjU6OTEzMzE4NTkxOjA/tasks/:taskId"; // local test server URL on different server
        //URL = "https://www.googleapis.com/tasks/v1/lists/MDM4NjIwODI0NzAwNDQwMjQ2MjU6OTEzMzE4NTkxOjA/tasks"; // Google tasks

        static $inject = ['$http', '$resource']; // Angular will inject the Data model service
